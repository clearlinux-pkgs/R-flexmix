...
Version  : 2.3.19
Release  : 52
URL      : https://cran.r-project.org/src/contrib/flexmix_2.3-19.tar.gz
Source0  : https://cran.r-project.org/src/contrib/flexmix_2.3-19.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679067451
