...
Version  : 2.3.18
Release  : 51
URL      : https://cran.r-project.org/src/contrib/flexmix_2.3-18.tar.gz
Source0  : https://cran.r-project.org/src/contrib/flexmix_2.3-18.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654701940
